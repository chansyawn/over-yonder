  ...
  return (
    <main className="grid min-h-screen place-items-center bg-white p-8 text-center text-black">
      <div className="max-w-xl">
        <p className="text-xs font-semibold uppercase">Off the map</p>
        <h1 className="mt-3 text-3xl font-semibold sm:text-4xl">This place could not be found</h1>
        <p className="mt-4 text-sm leading-6">
          The map or scene may no longer be available in the current scene pack.
        </p>
        <Link
